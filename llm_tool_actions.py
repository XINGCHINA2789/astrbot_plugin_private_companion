...
from .memo_tool_support import MemoToolSupport
from .helpers import (
...
""".strip()
    ...
    def _parse_memo_due_time(self, value: Any, *, now: float) -> tuple[float, str]:
        return MemoToolSupport(self._environment_fromtimestamp).parse_due_time(value, now=now)
    ...
    def _memo_tool_note_view(
        ...
        *,
        ...
        return MemoToolSupport(self._environment_fromtimestamp).note_view(
            note, number=number, content_limit=content_limit
        )
    ...
    def _memo_tool_find_matches(
        ...
        *,
        ...
        return MemoToolSupport(self._environment_fromtimestamp).find_matches(
            notes, selector, status=status
        )
