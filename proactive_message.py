...
from .proactive_delivery_policy import (
    is_onebot_event_checker_send_rejection,
    is_proactive_delivery_receipt_text,
    looks_like_internal_provider_error_text,
    strip_proactive_delivery_receipt_lines,
)
...
class ProactiveMessageMixin(FinalResponsePersistenceMixin):
    ...
    def _looks_like_internal_provider_error_text(text: Any) -> bool:
        return looks_like_internal_provider_error_text(text)
...
用户要求：{_single_line(request_text, 1200)}
    ...
    def _is_onebot_event_checker_send_rejection(error: Any) -> bool:
        return is_onebot_event_checker_send_rejection(error)
    ...
    def _is_proactive_delivery_receipt_text(text: str) -> bool:
        return is_proactive_delivery_receipt_text(text)
    ...
    def _strip_proactive_delivery_receipt_lines(self, text: str) -> str:
        return strip_proactive_delivery_receipt_lines(text)
